...
export default function Home() {
  return (
    <Layout>
      <section className="container mx-auto pt-14 lg:pt-24 min-h-[100vh] lg:min-h-[100vh] 2xl:min-h-[100vh] flex items-center lg:items-start lg:justify-center justify-start flex-col lg:flex-row ">
        ...
        <div className="lg:w-1/2 bg-green-30 h-full flex relative items-center justify-center overflow-hiden object-cover ">
          <Image
            ...
            height={1000}
            width={1000}
            className="object-cover w-full h-full lg:mb-20"
          />
