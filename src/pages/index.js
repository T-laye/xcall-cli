  ...
  return (
    <Layout>
      <section className="container mx-auto pt-14 lg:pt-24 h-[100vh] lg:h-[100vh] 2xl:h-[100vh] flex items-center lg:items-start lg:justify-center justify-start flex-col lg:flex-row ">
        <div className="lg:w-1/2 pt-24 flex justify-cente flex-col mb-10 lg:mb-0">
        ...
        <div className="lg:w-1/2 bg-green-30 h-full flex relative items-center justify-center overflow-hiden object-cover opacity-80">
          <Image
            src="https://cdn.dribbble.com/users/1373613/screenshots/5510801/media/adf3f3a5acf468eb1a2e23849ddbe4ec.gif"
            alt="validation"
            height={1000}
            width={1000}
            className="object-contain w-full h-full lg:mb-20"
          />
          <div className="absolute top-0 left-0 right-0 bottom-0 b mix-blend-darken ">
            {" "}
          </div>
        </div>
      </section>
